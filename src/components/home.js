    ...
    <div>
      ...
      <div className="">
        <div className="rest-container">
          <div>&nbsp;</div>
          <div className="w-[81%] mx-auto mb-[126px]">
            {/* description section */}
            <div className="mt-[67px] flex gap-[60px] text-[18px] font-normal leading-[21.6px]">
              <div className="w-[81%]">
            ...
            {/* pre-built solution */}
            <div className="mt-[94px] p-[33px] flex gap-9 bg-white rounded-[20px] leading-[48px]">
            ...
            {/* deep industry */}
            <div className="mt-[32px] p-[33px] flex gap-9 bg-white rounded-[20px] leading-[48px]">
